function [z_Rouw, P_Rouw] = rouwen(rho_Rouw, mu_uncond, sig_uncond, n_R)
% ------------------------------------------------------------------------
...
%
% Last line added to get standard definition of transition matrix 
% 			P(i,j) = Pr(y'=y(j)|y=y(i))
%
% Michael Dobrew, michael.dobrew@gmail.com, March 2020
% ------------------------------------------------------------------------
